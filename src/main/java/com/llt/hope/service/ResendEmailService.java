...
public class ResendEmailService {
    ...
    public String sendEmail(String to, String subject, String htmlContent) {
        ...
        Map<String, Object> emailRequest =
                Map.of("from", "no-reply@hopevn.site", "to", List.of(to), "subject", subject, "html", htmlContent);

        ResponseEntity<String> response = restTemplate.postForEntity(
                RESEND_API_URL, new org.springframework.http.HttpEntity<>(emailRequest, headers), String.class);
