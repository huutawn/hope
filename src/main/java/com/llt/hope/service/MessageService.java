...
public class MessageService {
    ...
    private void handleSenderMessageBox(User sender, User receiver, Message message) {
        try {
            MessageBox messageBox = messageBoxRepository
                    .findMessageBoxByReceiver(receiver, sender)
                    .orElse(null);
            ...
            log.error(
                    "Error handling sender message box for sender: {} and receiver: {}",
                    sender.getEmail(),
                    receiver.getEmail(),
                    e);
        }
    ...
    private void handleReceiverMessageBox(User sender, User receiver, Message message) {
        try {
            ...
            MessageBox receiverBox = messageBoxRepository
                    .findMessageBoxByReceiver(sender, receiver)
                    .orElse(null);
            ...
            log.error(
                    "Error handling receiver message box for sender: {} and receiver: {}",
                    sender.getEmail(),
                    receiver.getEmail(),
                    e);
        }
    ...
    private void sendMessageBoxUpdateNotification(String userEmail) {
        try {
            ...
            messagingTemplate.convertAndSendToUser(userEmail, "/queue/messagebox-updates", "MESSAGE_BOX_UPDATE");
