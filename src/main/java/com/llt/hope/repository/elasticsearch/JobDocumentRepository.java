...
public interface JobDocumentRepository extends ElasticsearchRepository<JobDocument, String> {
    ...
    @Query(
            "{\"bool\": {\"must\": [{\"multi_match\": {\"query\": \"?0\", \"fields\": [\"title^3\", \"description^2\", \"benefits^2\", \"suitableForDisability^2\", \"companyName^3\", \"location\", \"requirements\", \"responsibilities\"]}}]}}")
    ...
    @Query(
            "{\"bool\": {\"must\": [{\"range\": {\"salaryMin\": {\"lte\": ?1}}}, {\"range\": {\"salaryMax\": {\"gte\": ?0}}}], \"filter\": [{\"term\": {\"isActive\": true}}]}}")
    ...
    Page<JobDocument> findBySuitableForDisabilityContainingIgnoreCaseAndIsActiveTrue(
    ...
    @Query(
            "{\"bool\": {\"must\": [{\"multi_match\": {\"query\": \"?0\", \"fields\": [\"title^3\", \"description^2\", \"companyName^2\", \"location\", \"requirements\", \"responsibilities\", \"benefits\"]}}], \"filter\": [{\"term\": {\"isActive\": true}}]}}")
    Page<JobDocument> findByAdvancedSearch(
            String keyword,
            String location,
            String jobType,
            Long categoryId,
